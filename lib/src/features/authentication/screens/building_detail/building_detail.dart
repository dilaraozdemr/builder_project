    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
          model.isDurable??false ? Row(
          mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text(" Bina Sağlam", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              SizedBox(
                  width: 50,
                  height: 50,
                  child: Lottie.asset(AssetConstant.successLottie))
            ],
          ):Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text(" Bina Sağlam Değil", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            SizedBox(
                width: 50,
                height: 50,
                child: Lottie.asset(AssetConstant.errorLottie))
          ],
        ),
        SizedBox(height: 10,),
      Row(
